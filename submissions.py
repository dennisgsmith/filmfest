...
def submissions_download(browser, submissions_url):
    ...
    browser.find_element_by_xpath(
        '//*[@id="submission-index"]/div[3]/div[5]/div[2]/a[2]'
    ).click()  # open dropdown
    browser.find_element_by_xpath(
        '//*[@id="dropdown-export-content"]/ul/li[1]/a'
    ).click()  # select element from dropdown
    ...
    browser.find_element_by_xpath(
        '//*[@id="export_configuration"]/option[2]'
    ).click()  # select "Basic Summary"
    # browser.find_element_by_xpath('/html/body/div[9]/div[2]/div/form/div[2]/div/div[3]/label[3]').click() # uncomment if Excel input
    browser.find_element_by_xpath(
        "/html/body/div[9]/div[2]/div/form/div[3]/button"
    ).click()  # click export button
