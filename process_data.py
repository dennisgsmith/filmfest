...
# print(f"List of Duplicate Entries: {list(duplicate_entries['Project Title'])}")
...
# TODO: until further investigation
...
_ = ax1.pie(ratios, labels=labels, autopct='%1.1f%%', shadow=True)
